...
repositories (REFERENCES). This includes a function that automatically
extracts and prepares all of the time series features presented in
\tblref{tab:esmFeatures} (see the \texttt{featureExtractor} function in
...
For the full dataset across the three studies, we find that about 1.66\%
of the extracted features are missing across the 145 features per
participant. These missing features are imputed with a single predictive
mean matching imputation using the MICE library.
