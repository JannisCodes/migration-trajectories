...
For the variables in our illustration data set we chose an overall linear regression slope to capture the linear trend. The regression slope provides the average change from one time point $t$ to the next across all measurements $x$ of a time series $X$ of participant $i$ and variable $j$.
