...
We begin by importing the raw data as well as the variable meta data. Both of these data files are available as part of <a href="https://www.osf.io" target="_blank">our OSF repository</a>. To ensure the privacy and confidentiality of the study participants, we took a number of steps to pre-process the data:
