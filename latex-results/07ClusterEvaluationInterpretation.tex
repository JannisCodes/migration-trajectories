...
(\(difference\) = 1.028, \(t\)(150.83) = 7.50, \(p\) \textless{} .001,
\(95%CI [0.76, 1.30]), but these interactions were less voluntary (
\)difference\$ = -1.04, \(t\)(108.89) = -7.71, \(p\) \textless{} .001,
\(95%CI [-1.31, -0.77]), less meaningful (
\)difference\$ = -1.003, \(t\)(136.40) = -7.16, \(p\) \textless{} .001,
\(95%CI [-1.28, -0.73]), and less positive (
\)difference\$ = -1.38, \(t\)(152.31) = -11.94, \(p\) \textless{} .001,
\$95\%CI {[}-1.61, -1.15{]}). Such a finding is in line with past
research highlighting the role of negative intergroup interactions in
