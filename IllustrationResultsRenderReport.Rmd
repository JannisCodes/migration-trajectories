...
- 'The data repository for this manuscript is available at <a href="https://osf.io/" target="_blank">osf.io/TBD</a>'
...
```{r}
#| label: render cluster evaluation
#| include: true
#| results: 'asis'

rmarkdown::render(
  input = "sections/06ClusterEvaluation.Rmd",
  output_dir = outputDir
)
```
