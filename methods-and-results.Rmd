...
ggsave("Figures/clusterFeatVarComb.pdf", clusterFeatVarComb, width = 12, height = 10)
```
...
ggsave("Figures/clusterTsComb.pdf", clusterTsComb, width = 12, height = 10)
```
