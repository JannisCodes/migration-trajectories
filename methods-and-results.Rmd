...
The original studies included `r sum(missS123$pptFull)` participants ($N_{S1}=$`r missS123$pptFull[missS123$study==1]`, $N_{S2}=$`r missS123$pptFull[missS123$study==2]`, $N_{S3}=$`r missS123$pptFull[missS123$study==3]`) with a total `r format(sum(missS123$nFull), big.mark=",")` measurements. The studies differed substantially in the maximum length of participation ($N_{t:S1}=$`r missS123$timeFull[missS123$study==1]`, $N_{t:S2}=$`r missS123$timeFull[missS123$study==2]`, $N_{t:S3}=$`r missS123$timeFull[missS123$study==3]`). 
