...
For the central tendency: $Median$ where $X_{ij}$ is the an ordered list of values from the time series of variable $j$ for participant $i$. 
...
For distribution we chose the \textit{Median Absolute Deviation} ($MAD$), where we calculate the $Median$ (as in \eqref{eq:median}) for the absolute deviations of measurement $x$ at time point $t$ for participant $i$ and variable $j$. 
