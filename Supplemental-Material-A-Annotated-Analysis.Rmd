...
-   manual feature and variable selection
-   wrapper: procedures that add and/or remove predictors to find the optimal combination that maximizes model performance.
-   filter: relevance of the predictors outside of the predictive models and subsequently model only the predictors that pass some criterion.
-   dimension reduction for clustering. No selection more compression of redundant variance. 

```{r manual feature selection}


```

```{r automated feature selection}
