...
\begin{figure}[!hbtp] %hbtp
  ...
  \label{fig:tsClusTax}
  \centering\includegraphics[width=\textwidth]{figures/TS Cluster Flow/TS-cluster-taxonomy.pdf}
  \caption*{Note: \\
  Not exhaustive or ... .}
\end{figure}
