...
Time series features have also come to include more summaries in terms of measurement distribution, categorical states, and, importantly, nonlinear developments. As an example, \citet{kiwuwa-muyingo2011} proposed to extract clinically meaningful states for medical adherence data. 
