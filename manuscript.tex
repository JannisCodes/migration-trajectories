...
\keywords{
    ...
    \vspace{1em}
    Materials and software are available as part of our project GitHub repository \citep{KreienkampMasked-clust-github}. The full illustration code is also available as a tutorial-style website \citep{KreienkampMasked-illustration-github}. Materials, data, and code are available at \url{https://osf.io/75ryj/?view_only=db14031cd8704085b5c6165c9f5ed3e4} \citep{KreienkampMasked-clust-osf}.
}
